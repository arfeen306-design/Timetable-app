...
export default function Login() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (isSignUp) {
      ...
      if (!schoolName.trim())      { setError("Your name is required"); return; }
    ...
    try {
      if (isSignUp) {
        const res = await fetch("/api/auth/register", {
          ...
          body: JSON.stringify({ school_name: schoolName.trim(), email: email.trim(), password, phone: `${COUNTRIES[countryIdx].code} ${phone.trim()}` }),
        });
            ...
            <div className="roadmap-box">
              ...
              <div className="roadmap-grid">
                {[
                  ...
                  { n: 3, emoji: "👩‍🏫", label: "Teachers" },
                  { n: 4, emoji: "📚", label: "Subjects" },
                  { n: 5, emoji: "🎓", label: "Classes" },
                ...
                {isSignUp && (
                  <div className="lf-field">
                    ...
                    <div className="lf-input-wrap">
                      <input className="lf-input no-icon" type="text" placeholder="e.g. Zain ul Arfeen"
                ...
                {isSignUp && (
                  <div className="lf-field">
                    ...
                    <div className="lf-phone-row">
                      ...
                      >
                        {COUNTRIES.map((c, i) => (
                          <option key={c.code} value={i}>{c.flag} {c.code} {c.name}</option>
                        ))}
                      </select>
                      <div className="lf-input-wrap" style={{ flex: 1 }}>
                        <input className="lf-input no-icon" type="tel" placeholder="300 1234567"
